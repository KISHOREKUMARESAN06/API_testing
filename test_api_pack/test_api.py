import pytest
import requests
from api_functions_pack.functions import APIFunctions
from api_functions_pack.mock_data import TestData
...
class TestAPIFunctions:
    ...
    def test_fetch_data_by_id(self, setup):
        result = self.api_functions.fetch_data_by_id(26)
    ...
    def test_delete_data_by_id(self, setup):
        assert self.api_functions.delete_data_by_id(53) == False